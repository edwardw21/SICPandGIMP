...
(register-predicate! macro-definition? 'macro-definition)

(define (macro-definition-exp macro-defn) (cadr macro-defn))

(define (macro-definition-result macro-defn) (caddr macro-defn))
